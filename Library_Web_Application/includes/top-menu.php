                ...
                <div class="sidebar offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <ul class="navbar-nav justify-content-center align-items-center flex-grow-1 pe-3">
                        ...
                        <li class="nav-item mx-2">
                            <a class="nav-link" href="home.php" style="font-size: 20px;">Faqja kryesore</a>
                        </li>
                        <li class="nav-item mx-2">
                        ...
                        <?php if(!empty($_SESSION['iLoguar']) && $_SESSION['role'] == "admin") echo "<a href='admin_main_page.php' style='text-decoration: none; color: rgb(11, 125, 125);'>ADMIN</a>" ?>
...
//                                echo "<input type='submit' name='signIn' id='signIn' value='Sign In'>";
                          ...
                          ?>
                    <?php if(!empty($_SESSION['iLoguar']) && $_SESSION['role'] == "user") echo "<a href='delete_account.php' style='text-decoration: none; font-size: 15px;'>FSHI ADRESEN</a>" ?>
